...
import (
	...
	"github.com/alexkohler/noret"
)

func usage() {
	log.Printf("Usage of %s:\n", os.Args[0])
	log.Printf("\nnoret [flags] # runs on package in current directory\n")
	log.Printf("\nnoret [flags] [packages]\n")
	log.Printf("Flags:\n")
	flag.PrintDefaults()
}
func main() {
	...
	results, exitWithCode, err := noret.CheckForUnusedFunctionArgs(flag.Args(), flags)
	if err != nil {
